//START SCRIPT
window.onload = function(){  //window.onload function will run script as soon as page loads.

(function() {  //use IIFE function without window.onload function to test in dev console.
